...
export function NavigationBar({
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed top-[38px] right-0 left-0 z-[110] flex items-center justify-between px-5">
        {showBackButton && (
          <Link
            href={backButtonHref}
        ...
        <button
          ...
          className={cx(
            "flex h-12 w-12 items-center justify-center rounded-full bg-background/80 backdrop-blur-[60px] transition-colors hover:bg-background",
