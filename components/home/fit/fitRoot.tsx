...
export function FitRoot() {
  ...
  // Auto-cycle through items every 3 seconds (tablet+ only)
  useEffect(() => {
        ...
        <div>
          ...
          <div className="grid grid-cols-12 relative border-l-[0.5px] border-r-[0.5px] border-border before:absolute before:inset-x-[calc(-50vw+50%)] before:top-0 before:h-[0.5px] before:bg-border">
              ...
              <div className="col-span-5 flex items-center px-10">
                <p className="text-lg leading-normal tracking-[-0.04em] text-foreground">
            ...
            {/* Footer CTA */}
            <div className="px-5 desktop:px-10 flex items-center justify-between py-10 border-t-[0.5px] border-l-[0.5px] border-r-[0.5px] border-border">
              <p className="text-lg leading-normal tracking-[-0.04em] text-foreground max-w-[600px]">
                {content.footer.text}
              </p>
