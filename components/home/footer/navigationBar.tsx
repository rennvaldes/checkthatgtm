...
export function NavigationBar() {
  ...
  return (
    <>
      {/* Mobile Logo - Scrolls out of view */}
      <div className="md:hidden pt-16 pb-0">
        <Grid>
      ...
      >
        <Grid className="h-full items-center">
          ...
          {/* Navigation Links */}
          <div className="col-span-4 col-start-3 flex items-center gap-2 lg:gap-3 h-full">
            <Link
              href="/about"
              className={cx(
      ...
      {/* Mobile Hamburger - Only visible when scrolled */}
      {isScrolled && (
