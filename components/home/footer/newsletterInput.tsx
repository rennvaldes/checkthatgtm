    ...
    <div className={className}>
      <form onSubmit={handleSubmit} className="relative">
        <input
          ...
          className="w-full h-[48px] px-5 pr-14 rounded-full border border-muted-foreground/20 bg-background text-base text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-foreground disabled:opacity-50"
        />
        <button
          type="submit"
          disabled={isSubmitting}
