        ...
        <div className="w-full h-[400px] tablet:h-[500px] desktop:h-[600px] relative overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <button 
              ...
              className="pointer-events-auto bg-white/90 backdrop-blur-sm text-black px-6 py-3 rounded-full text-[14px] font-bold inline-flex items-center gap-3 h-12 shadow-lg hover:bg-white transition-colors"
            >
              <svg 
