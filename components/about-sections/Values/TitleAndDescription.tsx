...
export default function TitleAndDescription() {
  return (
    <div className='max-w-[520px] lg:w-full lg:max-w-[515px] sticky top-[40px] lg:top-[120px] lg:max-h-[200px] mx-auto'>
      ...
      <p className='text-[#ECECF6] font-elza font-[400] text-[16px] lg:text-[20px] leading-[150%] mt-2 lg:w-full'>
