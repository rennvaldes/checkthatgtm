...
export default function TestimonialsSection() {
  const testimonials: Testimonial[] = [
    ...
    {
      logo: { src: "https://growthxlabs-prod-strapi-bucket.s3.us-east-1.amazonaws.com/teleport_2a6d7a59e9.svg", alt: "Teleport" },
      quote:
  ...
  return (
    <section className="overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <ContentLayout
          leftContent={<div className="text-lg font-medium mb-4 md:mb-0">Testimonials</div>}
          rightContent={
            <div className="flex flex-col gap-8">
              <h2 className="text-3xl md:text-5xl font-semibold leading-[1.1] tracking-tight">
                Praise <br /> Why our customers love us
              </h2>
            </div>
          }
        />
          ...
          {testimonials.map((t, i) => (
            <SwiperSlide key={i}>
              <div className="p-8 border border-[#DCD9D5] h-[540px] flex flex-col justify-between lg:min-w-[520px] lg:max-w-[521px]">
                ...
                {/* Quote */}
                <p className="text-[24px] font-light leading-[1.3] tracking-tight text-[#151515]">
                  “{t.quote}”
                </p>
                ...
                <div className="flex items-center gap-3">
                  <div className="tracking-tight">
                    <div className="font-medium text-[#151515]">{t.authorName}</div>
                    <div className="text-sm text-[#303030]">{t.authorTitle}</div>
                  </div>
                </div>
              </div>
            </SwiperSlide>
