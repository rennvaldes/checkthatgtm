        ...
        rightContent={
          ...
          <div className="flex flex-col w-full [&_ul]:text-base sm:[&_ul]:text-lg">
            ...
            <FaqItem title={"What does the onboarding and project startup process look like?"}>
              ...
              <p><strong>Weeks 2-3: Foundation & Calibration</strong></p>
              ...
              <p><strong>Weeks 3-4: Content Production & Quality Assurance</strong></p>
              <p>We begin producing content across your selected workstreams, implementing our rigorous quality assurance process that combines AI-enhanced checks with expert human oversight from our managing editors and growth strategists. This phase focuses on establishing consistent output while maintaining the highest standards of quality and brand alignment.</p>
              <p><strong>Weeks 4-5: Distribution & Amplification</strong></p>
              <p>With content flowing, we activate our distribution channels including social media, link building campaigns, and SEO optimization. We set up tracking systems and begin measuring early performance indicators to identify what resonates most with your audience and drives the best results.</p>
              <p><strong>Weeks 5-6: Conversion Optimization & Lead Generation</strong></p>
              <p>We implement conversion-focused elements including gated content, lead magnets, and optimized calls-to-action. This phase focuses on turning the traffic and engagement we&apos;ve built into qualified leads and measurable business outcomes.</p>
              <p><strong>Weeks 6-7: Scale & Optimization</strong></p>
                <p>We analyze performance data from the first five weeks to identify winning strategies and double down on what&apos;s working. We refine our approach, scale successful tactics, and establish the foundation for ongoing growth. This final phase ensures you have a fully operational growth engine ready for long-term success.</p>
