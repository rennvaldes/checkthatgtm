...
function Mobile() {
  ...
  const scrollTo = React.useCallback((sectionId: string) => {
  ...
  return (
    <>
      <nav
        ...
        <button onClick={() => setIsOpen(true)} className='flex h-[32px] w-[32px] items-center justify-center'>
          <Menu />
        </button>
      </nav>
      ...
      <div
        ...
        <div className='flex items-center justify-between py-[16px] pl-[20px] pr-[16px] transition-transform duration-1000 group-aria-hidden:translate-x-[15%]'>
          <Logo />
          <button onClick={() => setIsOpen(false)} className='flex h-[32px] w-[32px] items-center justify-center'>
        ...
        <div className='flex flex-1 flex-col justify-between px-[20px] pb-[140px] pt-[20px] transition-transform duration-1000 group-aria-hidden:translate-x-[15%]'>
          <ul className='flex flex-col gap-[24px]'>
            <li>
              <button onClick={() => scrollTo('results-section')} className={OPTION_STYLES}>
                Our results
              </button>
            </li>
            <li>
              <button onClick={() => scrollTo('how-it-works-section')} className={OPTION_STYLES}>
                How it works
              </button>
            </li>
            <li>
              <button onClick={() => scrollTo('reviews-section')} className={OPTION_STYLES}>
                Reviews
              </button>
            </li>
            <li>
              <button onClick={() => scrollTo('pricing-section')} className={OPTION_STYLES}>
                Pricing
              </button>
            </li>
            <li>
