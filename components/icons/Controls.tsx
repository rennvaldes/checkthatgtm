...
export default function Controls({ className }: Props) {
  return (
    <svg
      ...
      <path d='M27.4813 40.5773H14.418' stroke='#656B9B' stroke-width='0.653165' />
      <path d='M66.0174 40.5773H36.625' stroke='#656B9B' stroke-width='0.653165' />
      <path d='M46.4231 11.838H14.418' stroke='#656B9B' stroke-width='0.653165' />
      <path d='M66.0179 11.838L54.9141 11.838' stroke='#656B9B' stroke-width='0.653165' />
      <path d='M61.4459 26.2076H14.418' stroke='#656B9B' stroke-width='0.653165' />
