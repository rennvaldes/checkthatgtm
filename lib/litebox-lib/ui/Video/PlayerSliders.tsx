...
export function Volume() {
  return (
    <VolumeSlider.Root className='volume-slider group relative mx-[7.5px] inline-flex h-10 w-full max-w-[80px] cursor-pointer touch-none select-none items-center outline-hidden aria-hidden:hidden'>
      <VolumeSlider.Track className='relative ring-media-focus z-0 h-[5px] w-full rounded-sm bg-white/30 group-data-focus:ring-[3px]'>
        <VolumeSlider.TrackFill className='bg-media-brand absolute h-full w-(--slider-fill) rounded-sm will-change-[width]' />
      </VolumeSlider.Track>
...
export function Time({ thumbnails }: TimeSliderProps) {
  return (
    <TimeSlider.Root className='time-slider group relative mx-[7.5px] inline-flex h-10 w-full cursor-pointer touch-none select-none items-center outline-hidden'>
          ...
          cues.map(cue => (
            <div
              ...
              <TimeSlider.Track className='relative ring-media-focus z-0 h-[5px] w-full rounded-sm bg-white/30 group-data-focus:ring-[3px]'>
                <TimeSlider.TrackFill className='bg-media-brand absolute h-full w-(--chapter-fill) rounded-sm will-change-[width]' />
